...
public sealed class IdempotentRequestAttribute : Attribute, IAsyncActionFilter
{
    ...
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        if (!context.HttpContext.Request.Headers.TryGetValue(
            ...
            out StringValues idempotenceKeyValue) || !Guid.TryParse(idempotenceKeyValue, out Guid idempotencyKey))
        {
            ...
            ProblemDetails problemDetails = problemDetailsFactory.CreateProblemDetails(
                ...
                title: "Bad Request",
                detail: $"Missing or invalid '{IdempotencyKeyHeader}' header. A valid GUID is required.");
