...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250714120542_auto_14040423_153539') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'identity') THEN
            CREATE SCHEMA identity;
        END IF;
    END IF;
...
BEGIN
    ...
    VALUES ('20250714120542_auto_14040423_153539', '9.0.9');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250715122528_auto_14040424_155515') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250715122528_auto_14040424_155515') THEN
    INSERT INTO identity."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250715122528_auto_14040424_155515', '9.0.9');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250923055032_auto_14040701_092017') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250923055032_auto_14040701_092017') THEN
    CREATE INDEX ix_otp_codes_phone_number_code ON identity.otp_codes (phone_number, code);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM identity."__EFMigrationsHistory" WHERE "migration_id" = '20250923055032_auto_14040701_092017') THEN
    INSERT INTO identity."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250923055032_auto_14040701_092017', '9.0.9');
    END IF;
END $EF$;
COMMIT;
